...
import com.wzy.lamanpro.dao.DBManager;
...
//                Log.e(TAG, "Progress : " + (writeCount * 100 / avi));
     ...
     * */
    public static boolean importDatabase(Context context,String dbPath) {
        // Close the SQLiteOpenHelper so it will commit the created empty
        // database to internal storage.
        DBManager.getInstance(context).closeDatabase();
        return copyFile(context.getDatabasePath("laman").getAbsolutePath(), dbPath);
    }
